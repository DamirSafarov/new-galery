...
document.getElementById('open-menu_mobile').addEventListener('click', function () {
	document.getElementById('mobile-menu').classList.add("active");
	document.querySelector('html').classList.add("lock");
})
...
document.getElementById('account-register').addEventListener('click', function () {
...
document.getElementById('close-popups').addEventListener('click', function () {
	document.getElementById('popup-register').classList.remove("active");
	document.querySelector('html').classList.remove("lock");
})



document.getElementById('register-succes').addEventListener('click', function () {
	document.getElementById('register-succesful').classList.add("active");
	document.querySelector('html').classList.add("lock");
})

document.getElementById('close-popupss').addEventListener('click', function () {
	document.getElementById('register-succesful').classList.remove("active");
	document.querySelector('html').classList.remove("lock");
})
